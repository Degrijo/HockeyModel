...
class Main:
    def __init__(self, root):
        ...
        root.configure(background="#1A5189")
        frame = tk.Frame(root, highlightthickness=1, highlightbackground='black', width=600, height=300)\
            .grid(row=0, column=1, sticky='ns', pady=(10, 10))
